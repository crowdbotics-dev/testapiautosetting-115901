...
## Project Structure
    ...
    ├── testapiautosetting_115901  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115901`
...
2. Clone this repo and `cd testapiautosetting_115901`
